      ...
      <div className="grid gap-6">
          ...
          <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
            <div>
              ...
              <p className="mt-3 max-w-2xl text-sm text-ink/65">
                Dit is de merklaag van het bedrijf. Hier bepaal je de naam, kleuren, logo en centrale notities die de
                eigenaar straks overal terugziet.
              </p>
        ...
        <Panel>
          ...
          <p className="mt-2 text-sm text-ink/65">
            Alle bedrijfsdocumenten op één plek. De eigenaar kan hier zijn RI&E notities bijhouden en documenten veilig opslaan.
          </p>
          <div className="mt-5 grid gap-6">
            <div className="rounded-[22px] border border-line bg-mist/60 p-5">
